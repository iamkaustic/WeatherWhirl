  ...
  return (
    <div className="grid grid-cols-2 gap-2">
      ...
      <div className={`${
        ...
        <div className="text-sm font-medium">{data.pressure} hPa</div>
      </div>
      ...
      <div className={`${
        ...
        <div className="text-sm font-medium">{Math.round(data.wind_speed)} m/s</div>
      </div>
      ...
      <div className={`${
        ...
        <div className="text-sm font-medium">{visibilityInKm} km</div>
      </div>
      ...
      <div className={`${
        ...
        <div className="text-sm font-medium">{Math.round(data.uvi)}</div>
      </div>
